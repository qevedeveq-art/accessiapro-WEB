...
//
// POST multipart vers /contact.php avec en-tete X-Requested-With,
// reponse JSON { ok: true } ou { error: "..." }, cles attendues
// name, email, company, need, message.
//
// Contraintes securite : aucun script tiers, aucun cookie, aucun
// stockage navigateur, aucun HTML injecte. Le rendu passe exclusivement
// par textContent. La CSP autorise connect-src 'self' et form-action 'self'
// mailto:.
